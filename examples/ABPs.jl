...
function simulation()
    ...
    forces = (Forces.self_align_with_v(1,0.0,false),Forces.self_propulsion(1,0.2),Forces.planar_rotational_noise(ontypes=1,Dr=.01),Forces.repulsive_soft_disk(1,2.),)
    ...
    sim = Euler_integrator(system,0.01, 300,Tplot=20,fps=60,plot_functions=(LPlot.disks_v_orientation!,LPlot.directors!),plotdim=2); 
    return sim;
