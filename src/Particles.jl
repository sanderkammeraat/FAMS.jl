...
@kwdef struct Polar <: Particle
    ...
    a::SVector{3, Float64}   = @SVector [0.0, 0.0, 0.0]
    f::SVector{3, Float64}   = @SVector [0.0, 0.0, 0.0]

    p::SVector{3, Float64}                                  #polarity vector
    q::SVector{3, Float64}   = @SVector [0.0, 0.0, 0.0]     #angular velocity
    alpha::SVector{3, Float64}   = @SVector [0.0, 0.0, 0.0] #angular acceleration
    T::SVector{3, Float64}   = @SVector [0.0, 0.0, 0.0]     #torque
